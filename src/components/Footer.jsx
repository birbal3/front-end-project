...
const FooterSection = () => {
  ...
  return (
    <footer className="bg-[#011B5B] text-white py-10 px-4">
      <div className="max-w-7xl mx-auto flex flex-wrap justify-between">
        {/* Social Media and Intro */}
        <div className="w-full md:w-1/5 mb-8 md:mb-0 pr-10 ">
      ...
      <div className="mt-10 text-center">
        <button 
          onClick={scrollToTop} 
          className="bg-[#FFA229] hover:bg-orange-500 text-white rounded-full p-4 mb-4 w-20 h-20 ">
          <span className="text-xl">&#8679;</span>
        </button>
        <p className="text-sm">© 2024 RegisterKaro. All Rights Reserved.</p>
        <p className="text-sm">Developed by Birbal.</p>
      </div>
    </footer>
  );
};
